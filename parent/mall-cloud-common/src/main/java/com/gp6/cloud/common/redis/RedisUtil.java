package com.gp6.cloud.common.redis;
...
public class RedisUtil {
    ...
    public boolean set(String key, String value) {
        try {
            ...
            LOGGER.error("Redis设置获取缓存失败,key:[{}],value:[{}],原因:[{}]", key, value, e);
        }
        return false;
    }
    ...
    public Long incr(String key, Long value) {
        try {
            ...
            LOGGER.error("Redis根据key:[{}]incr失败,原因:[{}]", key, value, e);
        }
        return null;
    }
    ...
    public String get(String key) {
        try {
            ...
            LOGGER.error("Redis根据[{}]获取缓存失败,原因:[{}]", key, e);
        }
        return null;
    }
    ...
    public boolean delete(String key) {
        try {
            ...
            LOGGER.error("Redis根据key:[{}]删除失败,原因:[{}]", key, e);
        }
        return false;
    }
